...
;A0403: db 0xc3
	ret
; install error handler (end)

times 0x0404-($-$$) nop ; restore error handler (begin)
A0404:
;A0404: db 0x1e
;A0405: db 0x06
;A0406: db 0x8b
...
A1f4c: db 0x22
A1f4d: db 0xb1
A1f4e: db 0x60 ; linecomp, pc -> 0x5f, ao486 -> 0x60
A1f4f: db 0xba
A1f50: db 0xd4
A1f51: db 0x03
A1f52: db 0xb0
...
vsync:
	push	dx ; A54d9: db 0x52
	push	ax ; A54da: db 0x50
A54db:
        mov     dx, 0x03da
A54de:
        in      al, dx
...
A554c: db 0x60 ; linecomp, pc -> 0x5f, ao486 -> 0x60
